...
public class AuthService {
    ...
    @Transactional(readOnly = true)
    public UserAccount requireUser(TypeThockPrincipal principal) {
    ...
    @Transactional
    public UserAccount requireUserForUpdate(TypeThockPrincipal principal) {
    ...
    public void deleteAccount(TypeThockPrincipal principal, String password) {
