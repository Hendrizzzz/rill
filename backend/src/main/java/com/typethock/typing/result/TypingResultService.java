...
import com.typethock.typing.result.ResultDtos.PaceBucket;
import com.typethock.typing.result.ResultDtos.PersonalRecord;
import com.typethock.typing.result.ResultDtos.RecordKey;
...
public class TypingResultService {
    ...
    TypingResultService(
            ...
            TypeThockProperties properties,
            JsonMapper json,
            Clock clock) {
    ...
    @Transactional
    public CreateOutcome create(TypeThockPrincipal principal, CreateResultRequest request) {
    ...
    public ResultPage page(TypeThockPrincipal principal, int limit, String cursorText) {
        if (limit < 1 || limit > 50) {
    ...
    @Transactional(readOnly = true)
    public ResultSummary summary(TypeThockPrincipal principal) {
    ...
    @Transactional(readOnly = true)
    public List<TypingResultResponse> export(TypeThockPrincipal principal) {
