...
import com.rill.typing.auth.AuthDtos.CredentialsRequest;
import com.rill.typing.auth.AuthDtos.SessionResponse;
...
public class AuthController {
    ...
    AuthController(
            AuthService authService, SessionService sessionService, RillProperties properties) {
    ...
    SessionResponse session(Authentication authentication, CsrfToken csrfToken) {
        RillPrincipal principal = RillPrincipalResolver.find(authentication);
    ...
    ResponseEntity<Void> logout(
            ...
            HttpServletResponse response) {
        RillPrincipalResolver.require(authentication);
